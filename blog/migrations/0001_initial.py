    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(limit_choices_to='is_superuser', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='blogs', to=settings.AUTH_USER_MODEL, verbose_name='نویسنده')),
                ('hits', models.ManyToManyField(blank=True, related_name='articles', to='blog.IpAddress', verbose_name='بازید')),
                ('tags', models.ManyToManyField(blank=True, related_name='blogs', to='blog.BlogTag', verbose_name='تگ ها / برچسب ها')),
            ],
            options={
                'verbose_name': 'مقاله',
