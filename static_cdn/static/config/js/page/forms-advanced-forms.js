...
$('.daterange-btn').daterangepicker({
  ranges: {
    ...
    '7 روز قب' : [moment().subtract(6, 'days'), moment()],
    '30 روز قبل': [moment().subtract(29, 'days'), moment()],
    'ماه قبل'  : [moment().startOf('month'), moment().endOf('month')],
    'ماه آینده'  : [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')]
  },
