...
createSeries("income", " درآمد ");
createSeries("expenses", " هزینه ها ");
}
function curveChart() {
	// Themes begin
	am4core.useTheme(am4themes_animated);
...
function waterfallChart() {
	...
	label.text = "{displayValue.formatNumber('5#,## a')}";
	label.align = "center";
	label.valign = "middle";
...
function candleStickChart(){
	...
	series.tooltipText = "باز:ت{openValueY.value}\nکم:ت{lowValueY.value}\nبالا:ت{highValueY.value}\nبسته:ت{valueY.value}";
