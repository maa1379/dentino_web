    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('کلینیک', 'کلینیک'), ('مطب', 'مطب'), ('لابراتوار', 'لابراتوار'), ('رادیوگرافی', 'رادیوگرافی')], max_length=12, null=True)),
                ('verified', models.BooleanField(default=False)),
                ('contracted', models.BooleanField(default=False)),
                ('parvaneh_clinic', models.ImageField(blank=True, null=True, upload_to='images/clinic/')),
                ('parvaneh_masole', models.ImageField(blank=True, null=True, upload_to='images/clinic/')),
                ('notification', models.CharField(blank=True, max_length=11, null=True, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '9137866088'. 10 digits allowed.", regex='^\\d{11}$')])),
                ('company', models.ManyToManyField(related_name='clinic', to='partial.Company')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='location.zone')),
            ],
        ),
        migrations.CreateModel(
            name='Service',
